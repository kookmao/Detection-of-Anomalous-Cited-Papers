...
# save result
result_df.to_csv('top_10_highest_variations_titles_and_ids_with_ranks.csv', index=False)

print("Process complete. The result has been saved to 'top_10_highest_variations_titles.csv'.")
